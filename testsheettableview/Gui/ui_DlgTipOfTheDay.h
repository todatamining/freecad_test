...
public:
    ...
    void setupUi(QDialog *Gui__Dialog__DlgTipOfTheDay)
    {
        if (Gui__Dialog__DlgTipOfTheDay->objectName().isEmpty())
            Gui__Dialog__DlgTipOfTheDay->setObjectName(QStringLiteral("Gui__Dialog__DlgTipOfTheDay"));
        ...
        pixmapLightbulb->setObjectName(QStringLiteral("pixmapLightbulb"));
        ...
        textTip->setObjectName(QStringLiteral("textTip"));
        QPalette palette2;
        ...
        textHeader->setObjectName(QStringLiteral("textHeader"));
        ...
        checkShowTips->setObjectName(QStringLiteral("checkShowTips"));
        ...
        buttonNextTip->setObjectName(QStringLiteral("buttonNextTip"));
    ...
    {
        Gui__Dialog__DlgTipOfTheDay->setWindowTitle(QApplication::translate("Gui::Dialog::DlgTipOfTheDay", "Tip of the day", 0));
        groupBox1->setTitle(QString());
        textTip->setText(QApplication::translate("Gui::Dialog::DlgTipOfTheDay", "Tip of the day", 0));
        textHeader->setText(QApplication::translate("Gui::Dialog::DlgTipOfTheDay", "<b><font face=\"Times New Roman\"><font size=\"+3\">Did you know...</font></font></b>", 0));
        checkShowTips->setText(QApplication::translate("Gui::Dialog::DlgTipOfTheDay", "&Show tips at start up", 0));
        checkShowTips->setShortcut(QApplication::translate("Gui::Dialog::DlgTipOfTheDay", "Alt+S", 0));
        buttonNextTip->setText(QApplication::translate("Gui::Dialog::DlgTipOfTheDay", "&Next Tip", 0));
        buttonNextTip->setShortcut(QApplication::translate("Gui::Dialog::DlgTipOfTheDay", "Alt+N", 0));
        buttonClose->setText(QApplication::translate("Gui::Dialog::DlgTipOfTheDay", "&Close", 0));
        buttonClose->setShortcut(QApplication::translate("Gui::Dialog::DlgTipOfTheDay", "Alt+C", 0));
    } // retranslateUi
