...
public:
    ...
    void setupUi(QWidget *DownloadItem)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/icons/view-refresh.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/icons/process-stop.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/icons/document-open.svg"), QSize(), QIcon::Normal, QIcon::Off);
